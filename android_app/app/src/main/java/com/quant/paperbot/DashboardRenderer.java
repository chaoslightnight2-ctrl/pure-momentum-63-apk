...
public class DashboardRenderer {
    public static String render(String status, String message, String ordersJson, String statsJson) {
        ...
        return "<!doctype html><html><head><meta name='viewport' content='width=device-width, initial-scale=1'>" +
            ...
            "</style></head><body><div class='hero'><h1>Pure Momentum 63</h1><div class='sub'>63 gun momentum, top 7 secim, 5 gun pozitif momentum filtresi, breadth cash rejimi, toplam 1.8x hedef exposure.</div><span class='pill'>" + safeStatus + "</span></div><div class='grid'>" +
            ...
            "<div class='card full'><div class='label'>Strateji ve risk kontrolleri</div><p>Pure momentum: TQQQ, TECL, SOXL, UPRO, SPXL, MSTR, COIN, MARA, RIOT, NVDA, AMD, PLTR, SMCI, TSLA, CVNA, APP, HOOD evreninde son 63 gun getirisi en guclu 7 sembol secilir; normal rejimde sembolun 5 gun momentumu da pozitif olmalidir. Breadth20 %50-%66 araligindaysa cash moduna gecer. Hedef gross exposure toplam 1.8x; piyasa saati, acik emir varsa tekrar gondermeme, alim gucu kontrolu, tam lot emir, API throttle ve retry aktif.</p></div>" +
