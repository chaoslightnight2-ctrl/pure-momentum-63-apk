...
The paper runner phase-locks the 7-trading-day rebalance cycle to the last successful rebalance date. Forced runs outside that locked phase are blocked unless `--ignore-phase-lock` is explicitly passed.
