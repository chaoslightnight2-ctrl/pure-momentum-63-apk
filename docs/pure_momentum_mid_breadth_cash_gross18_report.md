...
- Mid-breadth mode:
  ...
  - if `50% <= breadth20 < 66%` and SPY 20-day return is at least `+3%`, open a smaller 63-day top-3 sleeve at `1.0` gross
- Loss-regime sleeves:
...
| mid-breadth SPY20 >= +3%, top3 sleeve at 1.0 gross | 161.32x | 2.70 | -32.3% | 3.41 | 520 | -16.6% | 0.97 | 1.24 |
